...
const ProjectCard = ({ designation, tags =[], start, end }) => {
  ...
  return (
    <div className='mt-10 w-full flex gap-10 hover:bg-gray-800/10 transition duration-300 ease-in-out p-5 rounded-lg' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}  id='experience'>
      <div>
        {/* left side of card */}
      ...
      <div className='w-[78%] gap-4 flex flex-col'>
        {/* right side of card */}
        <h1 className={`text-[17px] text-white font-montserrat ${active ? "text-special" : "text-white"} transition duration-300 ease-in-out`}>{designation}</h1>
